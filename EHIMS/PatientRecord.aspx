<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PatientRecord.aspx.cs" Inherits="EHIMS.PatientRecord" %>
    ...
    <input type="text" class="form-control" id="email" placeholder="Reg Number"  name="reg">
		...
		<div class="form-group col-sm-6">
                ...
                <input type="Text" class="form-control" id="Complains"/>
                      ...
                      <div class="form-group col-sm-6">
                <asp:Label CssClass="control-label" runat="server">Doctors Comment:</asp:Label>
                ...
                <div class="form-group col-sm-6">
                <asp:Label CssClass="control-label" runat="server">Medication:</asp:Label>
